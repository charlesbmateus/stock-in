        ...
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
            <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                <div class="flex items-center flex-1 space-x-4">
                    <h5>
                        <span class="text-gray-500">Tous les produits:</span>
                        <span class="dark:text-white">{{ $totalStock }}</span>
                    </h5>
                    <h5>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3">Evaluation</th>
                        <th scope="col" class="px-4 py-3">Prix</th>
                        <th scope="col" class="px-4 py-3">A vendre</th>
                        <th scope="col" class="px-4 py-3">A envoyer</th>
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center">
                                    {{-- Bucle para estrellas amarillas --}}
                                    @for ($i = 0; $i < 5; $i++)
                                        @if ($i < $product->quality)
                                            {{-- Estrella amarilla si la calidad es suficiente --}}
                                            <svg aria-hidden="true" class="w-5 h-5 text-yellow-400" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                            </svg>
                                        @else
                                            {{-- Estrella gris si la calidad no es suficiente --}}
                                    ...
                                    {{-- Mostrar la calidad del producto en número --}}
                            ...
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">
                                <span class="inline-block w-4 h-4 mr-2 rounded-full {{ $product->sell ? 'bg-green-600' : 'bg-red-700' }}"></span>
                            </td>
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">
                                <span class="inline-block w-4 h-4 mr-2 rounded-full {{ $product->send ? 'bg-green-600' : 'bg-red-700' }}"></span>
                            </td>
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">
